...
public class SubnetTest {
    ...
    @Test
    public void setSNM() throws Exception {
        subnet1.setSNM("255");
    ...
    @Test
    public void getIP_array() throws Exception {
    ...
    @Test
    public void getSNM() throws Exception { // includes also getSubnetmask()
    ...
    @Test
    public void getSNM_array() throws Exception {
    ...
    @Test
    public void getSubnetmask_array() throws Exception {
    ...
    @Test
    public void getWildmarkMask() throws Exception {
    ...
    @Test
    public void getWildmarkMask_array() throws Exception {
    ...
    @Test
    public void getIQ() throws Exception {
    ...
    @Test
    public void getMagicNumber_min() throws Exception {
    ...
    @Test
    public void getMagicNumber_max() throws Exception {
    ...
    @Test
    public void getSubnetID_array() throws Exception {
    ...
    @Test
    public void getFirstAvailableIP() throws Exception {
    ...
    @Test
    public void getFirstAvailableIP_array() throws Exception {
    ...
    @Test
    public void getLastAvailableIP() throws Exception {
    ...
    @Test
    public void getLastAvailableIP_array() throws Exception {
    ...
    @Test
    public void getBroadCastIP() throws Exception {
    ...
    @Test
    public void getBroadCastIP_array() throws Exception {
    ...
    @Test
    public void getClassID() throws Exception {
    ...
    @Test
    public void getClassID_array() throws Exception {
    ...
    @Test
    public void getClassSNM() throws Exception {
    ...
    @Test
    public void getClassSNM_array() throws Exception {
    ...
    @Test
    public void getClassChar() throws Exception {
    ...
    @Test
    public void getNetbits() throws Exception {
    ...
    public void getNetbitsString() throws Exception {
    ...
    @Test
    public void getSubnetbits() throws Exception {
    ...
    @Test
    @SuppressWarnings("AssertWithSideEffects")
    public void getSubnetbitsString() throws Exception {
    ...
    @Test
    public void getHostbits() throws Exception {
    ...
    @Test
    @SuppressWarnings("AssertWithSideEffects")
    public void getHostbitsString() throws Exception {
    ...
    @Test
    public void getCountOfSubnets() throws Exception {
    ...
    @Test
    @SuppressWarnings("AssertWithSideEffects")
    public void getCountOfSubnets_calc() throws Exception {
    ...
    @Test
    public void getCountOfHosts() throws Exception {
    ...
    @Test
    @SuppressWarnings("AssertWithSideEffects")
    public void getCountOfHosts_calc() throws Exception {
    ...
    @Test
    public void isSupernetting() throws Exception {
    ...
    @Test
    public void getSubSubnets() throws Exception {
        // ((\d+\.){3}\d+) ((\d+\.){3}\d+)
        // new Subnet\("$1", "$3"\)
    ...
    @Test
    public void convertIntegerArrayToStringArray() throws Exception {
        assert Arrays.equals(Subnet.convertIntegerArrayToStringArray(new int[]{0, 1, 2}), new String[]{"0", "1", "2"}) : NOT_CORRECT;
    }

    @Test
    public void convertStringArrayToIntegerArray() throws Exception {
    ...
    @Test
    public void toStringDetailed() throws Exception {
